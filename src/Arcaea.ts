...
const loginUrl: string = 'https://arcapi.lowiro.com/7/auth/login',
      addUrl: string = "https://arcapi.lowiro.com/7/friend/me/add",
      delUrl: string = "https://arcapi.lowiro.com/7/friend/me/delete",
      friendInfo: string = "https://arcapi.lowiro.com/7/compose/aggregate?calls=%5B%7B%20%22endpoint%22%3A%20%22user%2Fme%22%2C%20%22id%22%3A%200%20%7D%2C%20%7B%20%22endpoint%22%3A%20%22purchase%2Fbundle%2Fpack%22%2C%20%22id%22%3A%201%20%7D%5D",
      friendRankUrl: string = "https://arcapi.lowiro.com/7/score/song/friend?start=0&limit=10",
      worldRankUrl: string = "https://arcapi.lowiro.com/7/score/song?start=0&limit=20",
      selfRankUrl : string= "https://arcapi.lowiro.com/7/score/song/me?start=4&limit=18";
...
export default class Arcaea{
    ...
    constructor(Arg?: IArcArg){
        ...
        let headers = Object.assign(header,{
            ...
            AppVersion: arg.appVersion || '2.3.0',
            'User-Agent': arg.userAgent || "Arc-mobile/2.3.0.1 CFNetwork/811.5.4 Darwin/16.7.0"
        });
        this.opt = {
            headers: headers,
            gzip: true
